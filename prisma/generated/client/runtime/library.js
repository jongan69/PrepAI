...
var ne = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
  ...
  ko = (e, r, t, n) => {
    if ((r && typeof r == 'object') || typeof r == 'function')
      for (let i of vu(r))
        !Su.call(e, i) && i !== t && Vt(e, i, { get: () => r[i], enumerable: !(n = Pu(r, i)) || n.enumerable });
    return e;
  };
var A = (e, r, t) => (
    (t = e != null ? xu(Tu(e)) : {}),
...
${c}`);
  ...
  return r === 'linux' && o && i
    ? `${o}-openssl-${i}`
    : (r !== 'linux' && Wt(`Prisma detected unknown OS "${r}" and may not work as expected. Defaulting to "linux".`),
...
var Yt = globalThis.window?.document !== void 0,
  ...
  Ig = Zr === 'Windows' || globalThis.navigator?.platform === 'Win32' || globalThis.process?.platform === 'win32',
  Dg =
    Zr === 'Linux' ||
...
m.toDecimalPlaces = m.toDP = function (e, r) {
  ...
  return (
    (t = new n(t)),
    e === void 0 ? t : (ie(e, 0, Ye), r === void 0 ? (r = n.rounding) : ie(r, 0, 8), y(t, e + t.e + 1, r))
  );
};
...
var L = (function () {
  ...
  return function (n, i, o, s, a, l) {
    var u,
      ...
      _ = i.d;
    if (!H || !H[0] || !_ || !_[0])
      return new qt(!n.s || !i.s || (H ? _ && H[0] == _[0] : !_) ? NaN : (H && H[0] == 0) || !_ ? ti * 0 : ti / 0);
    for (
    ...
    if (
      (_[p] > (H[p] || 0) && c--,
      o == null ? ((ae = o = qt.precision), (s = qt.rounding)) : a ? (ae = o + (n.e - i.e) + 1) : (ae = o),
      ae < 0)
    )
      (S.push(1), (h = !0));
    else {
          ...
          ((d = 0),
            ...
            u < 0
              ? ((me = b[0]),
                ...
                D < O && g.unshift(0),
                t(b, g, O, l),
                u == -1 && ((O = b.length), (u = r(_, b, K, O)), u < 1 && (d++, t(b, K < O ? fr : _, O, l))),
                (O = b.length))
              : u === 0 && (d++, (b = [0])),
            (S[p++] = d),
...
function Ji(e, r, t, n) {
  var i,
    ...
    h = t !== void 0;
  if (
    (h ? (ie(t, 1, Ye), n === void 0 ? (n = f.rounding) : ie(n, 0, 8)) : ((t = f.precision), (n = f.rounding)),
    !e.isFinite())
  )
    c = Ys(e);
  else {
    ...
    if (!p[0]) c = h ? '0p+0' : '0';
      ...
      if (
        (s < 0
          ? o--
          : ((e = new f(e)), (e.d = p), (e.e = o), (e = L(e, d, t, n, 0, i)), (p = e.d), (o = e.e), (u = Bs)),
        (s = p[t]),
        (a = i / 2),
        (u = u || p[t + 1] !== void 0),
        (u =
...
function Cd(e) {
  ...
  for (let n of e) {
    ...
    let i = `${n.selectionPath.join('.')}:${n.argumentPath.join('.')}`,
      o = r.get(i);
    o
      ? r.set(i, { ...n, argument: { ...n.argument, typeNames: Id(o.argument.typeNames, n.argument.typeNames) } })
      : r.set(i, n);
  }
...
var Ir = class e extends ze {
  ...
  getDeepField(r) {
    ...
    for (let s of n) {
      let a;
      if (
        (o.value instanceof e ? (a = o.value.getField(s)) : o.value instanceof Cr && (a = o.value.getField(Number(s))),
        !a)
      )
        return;
      o = a;
...
function _n({ args: e, errors: r, errorFormat: t, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  ...
  let { message: l, args: u } = kn(a, t),
    c = vn({ message: l, callsite: n, originalMethod: i, showColors: t === 'pretty', callArguments: u });
...
function eo(e, r) {
  e === void 0 &&
    r.isPreviewFeatureOn('strictUndefinedChecks') &&
    r.throwValidationError({ kind: 'InvalidSelectionValue', selectionPath: r.getSelectionPath(), underlyingError: Ca });
}
var Xi = class e {
  constructor(r) {
    this.params = r;
...
function Mr({ error: e, user_facing_error: r }, t, n) {
  return r.error_code
    ? new z(mm(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx })
...
var Wa = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  Ja = (e, r, t) => Wa(r).reduceRight((n, i, o, s) => Object.assign({}, ao(e, s.slice(0, o)), { [i]: n }), t);
function km(e, r) {
...
function uo(e, r) {
  let t = e._extensions.getAllModelExtensions(r) ?? {},
    n = [Mm(e, r), qm(e, r), wt(t), re('name', () => r), re('$name', () => r), re('$parent', () => e._appliedParent)];
  return he({}, n);
}
function Mm(e, r) {
  let t = Te(r),
...
function vt(e) {
  ...
  if (typeof e == 'object') {
    ...
    for (let t in e)
      t === '__proto__'
        ? Object.defineProperty(r, t, { value: vt(e[t]), configurable: !0, enumerable: !0, writable: !0 })
        : (r[t] = vt(e[t]));
    return r;
  }
  ar(e, 'Unknown value');
...
var Po,
  $l = {
    async loadLibrary(e) {
      ...
      if (t === void 0)
        throw new v(`The \`adapter\` option for \`PrismaClient\` is required in this context (${Gn().prettyName})`, r);
...
${a.backtrace}`,
  ...
  async requestBatch(r, { transaction: t, traceparent: n }) {
    ...
    ((this.lastQuery = JSON.stringify(i)),
      (this.executingQueryPromise = this.engine?.query(this.lastQuery, JSON.stringify({ traceparent: n }), Ll(t))));
...
It should have this form: { url: "CONNECTION_STRING" }`);
    ...
    adapter: (e, r) => {
      if (!e && Er(r.generator) === 'client')
        throw new k('Using engine type "client" requires a driver adapter to be provided to PrismaClient constructor.');
      if (e === null) return;
      if (e === void 0)
        throw new k('"adapter" property must not be undefined, use null to conditionally disable driver adapters.');
